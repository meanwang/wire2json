...
public final class AddBlackListRsp extends Message {
  ...
  public AddBlackListRsp(ByteString reserved_buf, Integer friend_type) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AddBlackListRsp)) return false;
    AddBlackListRsp o = (AddBlackListRsp) other;
  ...
  public static final class Builder extends Message.Builder<AddBlackListRsp> {
    ...
    public Builder(AddBlackListRsp message) {
      super(message);
