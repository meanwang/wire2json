...
public final class FollowRsp extends Message {
  ...
  public FollowRsp(ByteString reserved_buf, Integer friend_type) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof FollowRsp)) return false;
    FollowRsp o = (FollowRsp) other;
  ...
  public static final class Builder extends Message.Builder<FollowRsp> {
    ...
    public Builder(FollowRsp message) {
      super(message);
