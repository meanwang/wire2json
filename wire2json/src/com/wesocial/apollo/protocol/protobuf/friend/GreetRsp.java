...
public final class GreetRsp extends Message {
  ...
  public GreetRsp(ByteString reserved_buf, Integer friend_type) {
    this.reserved_buf = reserved_buf;
    this.friend_type = friend_type;
  }

  private GreetRsp(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GreetRsp)) return false;
    GreetRsp o = (GreetRsp) other;
  ...
  public static final class Builder extends Message.Builder<GreetRsp> {
    ...
    public Builder(GreetRsp message) {
      super(message);
    ...
    @Override
    public GreetRsp build() {
      return new GreetRsp(this);
    }
  }
}
