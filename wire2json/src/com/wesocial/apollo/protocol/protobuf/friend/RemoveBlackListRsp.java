...
public final class RemoveBlackListRsp extends Message {
  ...
  public RemoveBlackListRsp(ByteString reserved_buf, Integer friend_type) {
    this.reserved_buf = reserved_buf;
    this.friend_type = friend_type;
  }

  private RemoveBlackListRsp(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof RemoveBlackListRsp)) return false;
    RemoveBlackListRsp o = (RemoveBlackListRsp) other;
  ...
  public static final class Builder extends Message.Builder<RemoveBlackListRsp> {
    ...
    public Builder(RemoveBlackListRsp message) {
      super(message);
    ...
    @Override
    public RemoveBlackListRsp build() {
