...
public final class GetLocationDetailReq extends Message {
  ...
  public GetLocationDetailReq(ByteString reserved_buf, Double latitude, Double longitude) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetLocationDetailReq)) return false;
    GetLocationDetailReq o = (GetLocationDetailReq) other;
  ...
  public static final class Builder extends Message.Builder<GetLocationDetailReq> {
    ...
    public Builder(GetLocationDetailReq message) {
      super(message);
