...
public final class ReportArticleRsp extends Message {
  ...
  public ReportArticleRsp(ByteString reserved_buf) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ReportArticleRsp)) return false;
    return equals(reserved_buf, ((ReportArticleRsp) other).reserved_buf);
  }
  ...
  public static final class Builder extends Message.Builder<ReportArticleRsp> {
    ...
    public Builder(ReportArticleRsp message) {
      super(message);
