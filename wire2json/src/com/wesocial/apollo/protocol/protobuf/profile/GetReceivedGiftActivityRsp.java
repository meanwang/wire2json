...
public final class GetReceivedGiftActivityRsp extends Message {
  ...
  public GetReceivedGiftActivityRsp(ByteString reserved_buf, List<GiftActivity> gift_activity_list) {
    this.reserved_buf = reserved_buf;
    this.gift_activity_list = immutableCopyOf(gift_activity_list);
  }

  private GetReceivedGiftActivityRsp(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetReceivedGiftActivityRsp)) return false;
    GetReceivedGiftActivityRsp o = (GetReceivedGiftActivityRsp) other;
  ...
  public static final class Builder extends Message.Builder<GetReceivedGiftActivityRsp> {
    ...
    public Builder(GetReceivedGiftActivityRsp message) {
      super(message);
    ...
    @Override
    public GetReceivedGiftActivityRsp build() {
      return new GetReceivedGiftActivityRsp(this);
    }
  }
}
