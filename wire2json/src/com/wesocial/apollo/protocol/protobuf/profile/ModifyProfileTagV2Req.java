...
public final class ModifyProfileTagV2Req extends Message {
  ...
  public ModifyProfileTagV2Req(ByteString reserved_buf, List<String> tag_list) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ModifyProfileTagV2Req)) return false;
    ModifyProfileTagV2Req o = (ModifyProfileTagV2Req) other;
  ...
  public static final class Builder extends Message.Builder<ModifyProfileTagV2Req> {
    ...
    public Builder(ModifyProfileTagV2Req message) {
      super(message);
