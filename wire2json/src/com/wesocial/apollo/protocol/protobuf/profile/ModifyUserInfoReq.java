...
public final class ModifyUserInfoReq extends Message {
  ...
  public ModifyUserInfoReq(ByteString reserved_buf, AllUserInfo user_info) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ModifyUserInfoReq)) return false;
    ModifyUserInfoReq o = (ModifyUserInfoReq) other;
  ...
  public static final class Builder extends Message.Builder<ModifyUserInfoReq> {
    ...
    public Builder(ModifyUserInfoReq message) {
      super(message);
